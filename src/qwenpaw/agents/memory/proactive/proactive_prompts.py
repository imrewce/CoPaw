...
PROACTIVE_TASK_EXTRACTION_PROMPT = (
    ...
    "- Addresses tasks the user likely needs *now*, and queries for the "
    "newest information.\n"
    "- Avoids duplicating anything already in context, or similar to previous "
    "[PROACTIVE] labeled messages.\n"
    "\n"
    ...
    "\n"
    "Rules:\n"
    "- Return 1 to 3 tasks, ordered by priority (frequency then recency).\n"
